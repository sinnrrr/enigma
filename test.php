...
if (isset($_GET['category'])) {
    ...
    if (isset($_GET['status']) || isset($_GET['location']) && !empty($_GET['status'])) {
        $filter .= " AND ";
        ++$changed;
    }
}
    ...
    <form method="get">
        <section class="bg-dark text-white shadow-lg">
            <section class="d-flex justify-content-center">
                <div class="d-flex flex-column text-center ml-5 py-3 px-md-3">
                    <h5 class="text-center font-weight-bold"><?= $searchHeader ?></h5>
                    <!--search form-->
                ...
                <div class="d-none d-sm-block border border-white mt-5 ml-sm-3 mr-1 mb-3 border-right"></div>
                <div class="d-flex flex-column text-center ml-1 mt-5">
            ...
            <div class="text-center">
                <a role="button"
                   id="expand"
                   class="fas fa-chevron-down bg-dark text-primary py-1 px-5 text-decoration-none"
